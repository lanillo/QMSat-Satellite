/*
 * GPIO-struct-mock.hpp
 *
 *  Created on: 2018-04-12
 *      Author: Luis
 */

#ifndef GPIO_STRUCT_MOCK_HPP_
#define GPIO_STRUCT_MOCK_HPP_

typedef struct
{
    unsigned int CTRL;     /**< Port Control Register  */
    unsigned int MODEL;    /**< Port Pin Mode Low Register  */
    unsigned int MODEH;    /**< Port Pin Mode High Register  */
    unsigned int DOUT;     /**< Port Data Out Register  */
    unsigned int DOUTSET;  /**< Port Data Out Set Register  */
    unsigned int DOUTCLR;  /**< Port Data Out Clear Register  */
...
typedef struct {
    ...
    unsigned int EXTIPSELH;     /**< External Interrupt Port Select High Register  */
    unsigned int EXTIRISE;      /**< External Interrupt Rising Edge Trigger Register  */
    unsigned int EXTIFALL;      /**< External Interrupt Falling Edge Trigger Register  */
    unsigned int IEN;           /**< Interrupt Enable Register  */
    unsigned int IF;            /**< Interrupt Flag Register  */
    unsigned int IFS;           /**< Interrupt Flag Set Register  */
    unsigned int IFC;           /**< Interrupt Flag Clear Register  */

    unsigned int ROUTE;         /**< I/O Routing Register  */
    unsigned int INSENSE;       /**< Input Sense Register  */
    unsigned int LOCK;          /**< Configuration Lock Register  */
    unsigned int CTRL;          /**< GPIO Control Register  */
    unsigned int CMD;           /**< GPIO Command Register  */
