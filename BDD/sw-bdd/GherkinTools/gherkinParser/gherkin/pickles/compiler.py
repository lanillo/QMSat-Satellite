...
def _compile_scenario_outline(feature_tags, background_steps, scenario_outline,
    ...
    if len(scenario_outline['examples']) == 0:
        print('Scenario outline with no examples in scenario: ' + scenario_outline['name'])
        raise Exception('MissingExampleError')
        ...
        for values in examples['tableBody']:
            ...
            for scenario_outline_step in scenario_outline['steps']:
                ...
                _pickle_step = {
                    ...
                    'originalText': scenario_outline_step['text']
                }
